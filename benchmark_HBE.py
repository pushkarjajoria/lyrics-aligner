...
if __name__ == "__main__":
    timestamps = build_timestamp_cache("/nethome/unknown_user/Github/lyrics-aligner/dataset/Aria_Dataset", "/nethome/unknown_user/Github/lyrics-aligner/results/multilingual_predictions")
